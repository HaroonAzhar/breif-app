...
import {getCheckoutSessionIdCms, registerNew} from "../../../app/api";
    ...
    const attemptSignup = async () => {
        ...
        if (response) {
            if (accountType === "membership") {
                ...
                const checkoutSessionResponse = await getCheckoutSessionIdCms(code);
                                ...
                                <Grid item xs={12}>
                                    <RadioGroup row defaultValue={"membership"}>
                                        ...
                                        <FormControlLabel value={"membership"}
                                                          ...
                                                          label={"Subscription* / £17.99 a month"}/>
                                    </RadioGroup>
                                </Grid>
                            </div>
